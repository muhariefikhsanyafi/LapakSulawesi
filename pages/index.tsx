        ...
        <div className="konten-utama">
          ...
          <div className="wadah-formulir">
              <form onSubmit={tanganiKirimFormulir}>
                  ...
                  <div className="grup-formulir"><label htmlFor="fromInput">Nama Anda: <span className="wajib">*</span></label><input type="text" id="fromInput" className="input-formulir" placeholder="Contoh: Bacce" value={nama} onChange={e => aturNama(e.target.value)} required /></div>
                  <div className="grup-formulir"><label htmlFor="emailInput">Email: <span className="wajib">*</span></label><input type="email" id="emailInput" className="input-formulir" placeholder="Contoh: bacce@lapaksulawesi.biz.id" value={email} onChange={e => aturEmail(e.target.value)} required /></div>
